        ...
        if(f1 is POINT){
            if(f2 is POINT && ((POINT)f1).param1==((POINT)f2).param1 && ((POINT)f1).param3==((POINT)f2).param3){
                ...
                if(((RAY)f2).param1 == ((RAY)f2).param3 && ((POINT)f1).param1==((RAY)f2).param1){
                        ...
                        if((((RAY)f2).param2 == ((RAY)f2).param4 && ((POINT)f1).param2==((RAY)f2).param2 )|| (((RAY)f2).param2  >((RAY)f2).param4 && ((POINT)f1).param2<=((RAY)f2).param2 ) || (((RAY)f2).param2  < ((RAY)f2).param4 && ((POINT)f1).param2>=((RAY)f2).param2 )){// vector director negativo
                ...
                if(((POINT)f1).param1*m+n==((POINT)f1).param3){
                        ...
                        if((((RAY)f2).param1  >((RAY)f2).param3 && ((POINT)f1).param1<=((RAY)f2).param1 ) || (((RAY)f2).param1  < ((RAY)f2).param3 && ((POINT)f1).param1>=((RAY)f2).param1 )){// vector director negativo
            ...
            if(((SEGMENT)f1).param1!=((SEGMENT)f1).param3){
                    ...
                    if(b*b-4*a*c >=0)
                    {
                        ...
                        if(x>=minAbsc && x<=maxAbsc){// vector director negativo
                        ...
                        if(x!=x41 && x41>=minAbsc && x41<=maxAbsc){// vector director negativo
                    ...
                    if(Math.Pow(((CIRCLE)f2).param3,2) - Math.Pow(((CIRCLE)f2).param1-((SEGMENT)f1).param1,2)>=0){
                        ...
                        if(y>=MinY && y<=MaxY){// vector director negativo
